        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            <NavLink to="/" className="flex items-center gap-2 text-xl font-bold text-gray-900 tracking-tight transition-opacity hover:opacity-90">
              <span className="p-1.5 bg-[#166E52]/10 rounded-lg text-[#166E52]">
                <Leaf size={22} className="fill-[#166E52]/20" />
              </span>
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold transition-all duration-200 ${
                      isActive
                        ? 'text-[#166E52] bg-[#166E52]/5'
                        : 'text-gray-600 hover:text-[#166E52] hover:bg-gray-50'
                    }`
                  }
                >
                  <Icon size={16} />
          ...
          <div className="flex items-center md:hidden">
            <button
              ...
              type="button"
              className="inline-flex items-center justify-center p-2 rounded-xl text-gray-400 hover:text-[#166E52] hover:bg-gray-50 focus:outline-none transition-colors"

    ...
    <footer className="bg-white border-t border-gray-100 py-8 text-center mt-auto w-full">
      <div className="max-w-7xl mx-auto px-4 space-y-4">
        ...
        <div className="flex flex-wrap justify-center items-center gap-x-6 gap-y-2 text-xs font-semibold text-gray-500">
          <Link to="/" className="hover:text-[#1D9E75] transition-colors">Dashboard</Link>
          <span className="text-gray-300">|</span>
          <Link to="/log" className="hover:text-[#1D9E75] transition-colors">Log Activity</Link>
          <span className="text-gray-300">|</span>
          <Link to="/insights" className="hover:text-[#1D9E75] transition-colors">Insights</Link>
          <span className="text-gray-300">|</span>
          <Link to="/challenges" className="hover:text-[#1D9E75] transition-colors">Challenges</Link>
        </div>
